...
<!-- jQuery first, then Popper.js, then Bootstrap JS -->
    <script src="{{ asset('frontend/jsjquery-3.4.1.min.js') }}"></script>
    ...
    <script src="{{ asset('frontend/jsjquery.meanmenu.min.js') }}"></script>
    <script src="{{ asset('frontend/jsslick.min.js') }}"></script>
    <script src="{{ asset('frontend/jsjquery.nice-select.min.js') }}"></script>
